...
namespace System
{
    public static class TypeExtension
    {
        ...
        public static MethodInfo GetMethodBySignature( this Type @this, MethodInfo method)
        {
        ...
        public static bool IsVisibleAndVirtual( this PropertyInfo @this)
            => (@this.CanRead && @this.GetMethod.IsVisibleAndVirtual()) || (@this.CanWrite && @this.GetMethod.IsVisibleAndVirtual());

        public static bool IsVisibleAndVirtual( this MethodInfo @this)
        {
        ...
        public static bool IsVisible( this MethodBase @this)
            => @this.IsPublic || @this.IsFamily || @this.IsFamilyOrAssembly;
        ...
        public static Func<T, object> GetValueGetter<T>( this PropertyInfo @this)
        {
        ...
        public static Func<object, object> GetValueGetter( this PropertyInfo @this)
        {
        ...
        public static Action<object, object> GetValueSetter( this PropertyInfo @this)
        {
        ...
        public static Action<T, object> GetValueSetter<T>( this PropertyInfo @this) where T : class
        {
        ...
        /// <param name="this">type</param>
        /// <returns></returns>
        public static bool HasEmptyConstructor( this Type @this)
